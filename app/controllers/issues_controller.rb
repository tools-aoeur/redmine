...
class IssuesController < ApplicationController
  ...
  def update_issue_from_params
    ...
    if issue_attributes && params[:conflict_resolution]
      ...
      when 'auto_merge'
        issue_attributes = automatically_merge_issue_attributes(issue_attributes)
      when 'add_notes'
  ...
  def automatically_merge_issue_attributes(issue_attributes)
    issue_conflict_analyzer(issue_attributes).auto_merge_attributes
  end
  ...
  def build_conflicting_fields_summary
    issue_conflict_analyzer.actual_conflicting_fields.map(&:label)
  end
